...
import com.pedropathing.panels.configurables.variables.instances.CustomVariable
import com.pedropathing.panels.configurables.variables.instances.ErrorVariable
import com.pedropathing.panels.configurables.variables.instances.RecursionReachedVariable
import com.pedropathing.panels.configurables.variables.instances.UnknownVariable
import com.pedropathing.panels.configurables.variables.instances.UnsupportedVariable
...
fun processValue(
    recursionDepth: Int,
    className: String,
    type: com.pedropathing.panels.configurables.variables.BaseTypes,
    reference: MyField,
...
//        Logger.configurablesLog("Package ${reference.genericType?.javaClass?.packageName}")
        ...
        if (type in listOf(
                com.pedropathing.panels.configurables.variables.BaseTypes.INT, com.pedropathing.panels.configurables.variables.BaseTypes.DOUBLE, com.pedropathing.panels.configurables.variables.BaseTypes.FLOAT,
                com.pedropathing.panels.configurables.variables.BaseTypes.LONG, com.pedropathing.panels.configurables.variables.BaseTypes.STRING, com.pedropathing.panels.configurables.variables.BaseTypes.BOOLEAN, com.pedropathing.panels.configurables.variables.BaseTypes.ENUM
            )
        ) {
            return currentManager
        }

        if (type == com.pedropathing.panels.configurables.variables.BaseTypes.CUSTOM) {
...
//                }
            ...
            return CustomVariable(reference.name, className, customValues, com.pedropathing.panels.configurables.variables.BaseTypes.CUSTOM)
        }

        if (type == com.pedropathing.panels.configurables.variables.BaseTypes.ARRAY) {
            ...
            if (componentValues != null && componentType != null) {
                val arrayValues = (0 until Array.getLength(componentValues)).map { i ->
                    ...
                    val itemType = if (arrayType == com.pedropathing.panels.configurables.variables.BaseTypes.UNKNOWN) {
                        getType(value.javaClass)
                    } else {
                        arrayType
                    }
                    val cType = if (arrayType == com.pedropathing.panels.configurables.variables.BaseTypes.UNKNOWN) {
                        value.javaClass
                    } else {
                        componentType
                    }
                ...
                return CustomVariable(reference.name, className, arrayValues, com.pedropathing.panels.configurables.variables.BaseTypes.ARRAY)
            } else {
                return UnknownVariable(className, reference.name)
            }
        }

        if (type == com.pedropathing.panels.configurables.variables.BaseTypes.LIST) {
            ...
            if (listInstance != null) {
                ...
                return CustomVariable(reference.name, className, listValues, com.pedropathing.panels.configurables.variables.BaseTypes.LIST)
            }
        }

        if (type == com.pedropathing.panels.configurables.variables.BaseTypes.MAP) {
            ...
            if (mapInstance != null) {
                ...
                return CustomVariable(reference.name, className, mapValues, com.pedropathing.panels.configurables.variables.BaseTypes.MAP)
            }
        }

...
class MyField(
    ...
    val possibleValues = when (myType) {
        com.pedropathing.panels.configurables.variables.BaseTypes.BOOLEAN -> listOf("true", "false")
        com.pedropathing.panels.configurables.variables.BaseTypes.ENUM -> ref?.type?.enumConstants?.map { it.toString() }
        else -> null
    }
